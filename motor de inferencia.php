    ...
    */
    public function agregacion($activadas){
        ...
        foreach ($activadas as $activada){   //para cada regla con su correaspondiente valor del antecedente
            ...
            else{ //si no está entonces creamos el conjunto de valores discretos de la variable linguistica que seran de utilidad para realizar la agregacion
